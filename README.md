...
<p>Программа компилируется с помощью команды <i>make</i>. Запускается при вводе в терминал либо <i>./key.out</i>либо <i>make test</i>. Файлы test.txt и answer.txt самому создавать не требуется.</p>